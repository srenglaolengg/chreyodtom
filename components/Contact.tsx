      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="lg:w-1/2 h-80 lg:h-auto rounded-lg shadow-lg overflow-hidden">
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3908.43123456789!2d105.3512345!3d11.5912345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTPCsDQ5JzIzLjQiTiAxMDXCsDIxJzE1LjYiRQ!5e0!3m2!1sen!2skh!4v1625234567890!5m2!1sen!2skh" 
                    width="100%" 
                    height="100%" 
                    style={{ border: 0 }} 

...
const Admin: React.FC<AdminProps> = ({ user, isAdmin, authLoading }) => {
    ...
    if (authLoading) {
        return (
            <>
                ...
                <div className="min-h-screen flex items-center justify-center bg-stone-100">Authenticating...</div>
            </>
        );
    }
    ...
    return (
        <>
            <PageMeta title="Admin Panel | Wat Serei Mongkol" description={metaDescription} robots={metaRobots} />
